    ...
    <div id="detail" v-if="audio.data && !loading">
        <div class="detail-container">
            ...
            <div class="detail-user">
                <div class="user-left">
                    <div class="user-img-container">
                        <img :src="audio.data.sound.user.avatar_50" alt="" class="user-img">
                        <img v-if="audio.data.sound.user.famous_type" src="https://ws-qn-echo-image-cdn.app-echo.com/Foz1CX1MdKHnTiDV26btgAmDJ3Y-?imageMogr2/auto-orient/quality/100%7CimageMogr2/thumbnail/!100x100r/gravity/Center/crop/100x100/dx/0/dy/0" alt="" class="user-vip">
                    </div>
            ...
            <div class="detail-cover">
                <img :src="audio.data.sound.pic_500" alt="" class="cover-img">
        ...
        getMusicData() {
            ...
            getDetail(id).then(res=>{
                ...
                if(res && res.data.data) {
                    this.SET_AUDIO_DATA(res.data.data);
                }
            }).catch(()=>{
                this.$indicator.close();
                this.loading = false;
